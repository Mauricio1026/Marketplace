...
if (isset($_POST["cr"])) {
	...
	$SQL = "INSERT INTO USUARIO (NOMBRE, APELLIDO, CORREO, TELEFONO, DIRECCION, GENERO, FECHANACIMIENTO, CIUDAD, NACIONALIDAD, CONTRASEÑA, CONTRASEÑAREPETIDA) VALUES (:nombre, :descripcion, :foto, :fecha, :capacidad,:precio, :pass1,:pass2)";
	$Resultado = $conexion_db->prepare($SQL);
	$Resultado->execute([":nom" => $Nombre, ":ape" => $Apellido, ":correo" => $Correo, ":tel" => $Telefono, ":direc" => $Direccion, ":genero" => $Genero, ":fechanacim" => $FechaNacimiento, ":ciudad" => $Ciudad, ":nacio" => $Nacionalidad, ":pass1"=>$pass1,":pass2"=>$pass2]);
...
<Form action="<?php echo $_SERVER['PHP_SELF']; ?> " method="post">
	<table width="50%" border="0" align="center">
		...
		<tr>
			<td>Telefono: </td>
			<td><input type='text' name='tel' size='30' class='centrado' required></td>
		</tr>
		<tr>
			<td>Dirección: </td>
